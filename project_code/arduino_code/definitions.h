...
int ledPin = 13;
int iArray_pins_filas[7]={2,3,4,5,6,7,8};    //List of PINs of Arduino
int pinBoton = 9;
...
const int i_num_max_pixels = i_size_array_characters*(i_num_pixels_per_matrix+i_pixels_between_chars); //5 pixels/char + 1 pixel/space between them

byte ptr_by_ascii_char[i_size_array_characters];  /* BRIDGE BETWEEN INPUT WORDS AND THE DOT MATRIX FONT */
byte ptr_by_frase [i_size_array_characters][7]; //[letra][fila]   //Sentence that will be displayed; Number of characters x Number of rows
byte ptr_by_byte_to_send_per_row[i_size_array_characters];

/******************************************************************************
    VARIABLES TO DISPLACE AND SHOW THE WHOLE MESSAGE
********************************************************************************/
int i_num_desplazamientos = i_num_pixels_per_matrix+i_pixels_between_chars;


/******************************************************************************
             TIMER
********************************************************************************/
const int i_number_of_steps_for_desplazamiento = 3;
int i_steps_counter;

int i_tMaxTimePerLetra = 50;
int i_tTimeCounterForLetra = 0;

/****************************************************************************************************/
/*                       DOT MATRIX FONT                                                            */
/****************************************************************************************************/

byte led_font_list[97][7] = {
  ...
  { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1f   },   // 0x5f, _
   ...
   {0x10, 0x00, 0x1f, 0x02, 0x04, 0x08, 0x1f},   // 0x7a, z
